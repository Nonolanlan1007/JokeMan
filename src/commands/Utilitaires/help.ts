...
class Help extends Command {
    ...
    async run(client: Class, message: Message, args: string[]): Promise<Message<boolean>> {
        if (!args[0]) {
            ...
            commandsList.push({
                name: "➜ Liens :",
                value: "[GitHub](https://github.com/Nonolanlan1007/JokeMan) • [Signaler un bug](https://github.com/Nonolanlan1007/JokeMan/issues/new)"
            });
                ...
                embeds: [
                    {
                        ...
                        footer: {
                            text: `JokeMan | Version ${client.version}`
                        }
                    }
                ]
            });
